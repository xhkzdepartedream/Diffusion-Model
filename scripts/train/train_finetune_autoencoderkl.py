...
from AutoEncoder.AutoencoderKL_trainer import AutoencoderKL_trainer
...
def main():
    ...
    dir = '/path/to/your/celeba_hq_256/'
    ...
    pretrained_model_name_or_path = "/path/to/your/autoencoderkl/"
    ...
    cos_weight = 0.5
    warm_up = 10
    ckpt = "/path/to/your/autoencoderkl.pth"
